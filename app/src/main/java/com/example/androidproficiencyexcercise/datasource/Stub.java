...
public class Stub {
    public static List<CanadaRecord> getRecords(){
        ...
        canadaRecord.setDescription("They are second only to humans in their ability to manipulate and change their environment. They can measure up to 1.3 metres long. A group of beavers is called a colony");
        canadaRecord.setTitle("Beavers");
        canadaRecord.setImageReference("http://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/American_Beaver.jpg/220px-American_Beaver.jpg");
